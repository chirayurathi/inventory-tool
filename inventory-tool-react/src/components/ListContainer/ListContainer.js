    ...
    return(
        <div className={Style.ListContainer}>
            <div className={Style.Lists} style={{transform:`translateX(${props.slider*-100}%)`}}>
                ...
                <UnitList activeProductUnit={props.activeProductUnit} getQr={props.getQr} selectUnitHandler={props.selectUnitHandler} addUnit={props.addUnit} backHandler={props.backHandler} addToggleHandler={props.addToggleHandler} allEmployesDict = {props.allEmployesDict}/>
